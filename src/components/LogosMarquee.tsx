...
export const LogosMarquee = ({ logos = defaultLogos }: LogosMarqueeProps) => {
  ...
  const gridRef = useScrollAnimation<HTMLDivElement>(200);

  return (
    <section className="py-16 bg-gradient-to-b from-background to-muted/20">
      <div className="container mx-auto px-6">
        <h2 ref={titleRef} className="text-2xl sm:text-3xl font-bold text-center text-foreground mb-12">
          Personal brands using our software and 1:1 mentoring
        </h2>
        
        <div ref={gridRef} className="grid grid-cols-2 md:grid-cols-5 gap-8 justify-items-center max-w-4xl mx-auto">
